...
class CustomTokenObtainPairSerializer(TokenObtainPairSerializer):
    def validate(self, attrs):
        ...
        if user:
            ...
            # Optimization: Return user profile with token to avoid second request
            # Import here to avoid circular dependency if any (though usually fine at top)
            from .serializers import UserSerializer
            serializer = UserSerializer(user)
            data['user_profile'] = serializer.data
...
from prescriptions.models import Notification
from prescriptions.serializers import NotificationSerializer
